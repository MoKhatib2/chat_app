...
class _AuthScreenState extends State<AuthScreen> {
  ...
  void _submit() async {
    ...
    if (!isValid || !_isLogin && _selectedImage == null) {
      _showSnackBarMessage('Authentication faild.');
      return;
    }
    ...
    try {
      ...
      if (_isLogin) {
        ...
        if (allUsers.docs.isNotEmpty) {
          usernameTaken = allUsers.docs.where((user) {
            return user.data()['username'] == _enteredUsername;
          }).isNotEmpty;
        }
        ...
        if (usernameTaken) {
          ...
          _showSnackBarMessage('This username is taken.');
          return;
        }
